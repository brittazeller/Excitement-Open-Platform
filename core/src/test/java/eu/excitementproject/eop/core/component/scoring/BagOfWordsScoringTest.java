...
//			bolexs = new BagOfLexesScoringDE(config);
			bolexs = new BagOfLexesScoringDE(true, false, "", true, new String[]{"Causes","Entails","Has_Hypernym","Has_Synonym"}, "./src/main/resources/ontologies/germanet-7.0/GN_V70/GN_V70_XML/", false, false, false, false);
			
//			bolexposs = new BagOfLexesPosScoringDE(config);
			bolexposs = new BagOfLexesPosScoringDE(true, false, "", true, new String[]{"Causes","Entails","Has_Hypernym","Has_Synonym"}, "./src/main/resources/ontologies/germanet-7.0/GN_V70/GN_V70_XML/", true, true, "10", false, false, false);
